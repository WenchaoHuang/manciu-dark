...
and TextMate scope tuning for C/C++, Python, CMake, CUDA, LaTeX, Markdown, USDA and common data
formats.
...
- Additional scope tuning for C++, Python, CUDA, CMake, JSON, YAML, TOML, XML, USDA
  and LaTeX
